<?php
 ...
 p.student = '$std' and l.type = '$type' and l.acc_year='$acy' and l.course in (select code as course from courseunit where department='$getcodept' and level='$getcolv' order by code)";
							}
			else{*/
