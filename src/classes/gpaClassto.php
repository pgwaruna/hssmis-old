<?php
	...
	class calculate
	{
			...
			$get_code="select distinct(cr.course),cu.credits from courseunit cu, registration cr, results re where cr.student='$student' and cr.course=cu.code and cr.degree='1' and cr.confirm=1 and cr.course=re.subject and re.index_number='$student' order by cu.level,cu.semister,cu.code";
			...
			//edited for fsc 6 credt.....

		public function allfsccredit($student)
			{
                $get_fsccrdt="select sum(cu.credits) from courseunit cu, registration cr where cr.student='$student' and cr.degree='1' and cr.confirm=1 and cr.course=cu.code and cu.core='op'and cu.code LIKE 'FSC%'";
                $result_fsccrdt=mysql_query("$get_fsccrdt");
                    while($row=mysql_fetch_array($result_fsccrdt)){
                          $fscsumcrd=$row['sum(cu.credits)'];
                                }
	       ...
	       public function allsubcocredit($subject)
            {
               ///////get total credit from course_unit table for above subject////
                ...
                $selectioncode=array();
                    ...
                    if($subject=="industrial_mathematics"){
                        $selectioncode[5]="AMT221b";
                    }


                            $get_credit="select distinct(cu.code),cu.credits as cdt from courseunit cu, target_group tg, combination co  where tg.subject='$subject' and tg.target_id=cu.target_group and co.subject='$subject'and co.department=cu.department and cu.core='co' and (cu.type='Theory' or cu.type='Th+Pr') and cu.availability=1";
			...
			////////////////////////////////////////////////////////////////////////
			////////////////////////////////////////////////////////////////////////
              public function allsubcredit($subject)
            {
               ///////get total credit from course_unit table for above subject////
                $alcredit=0;
                $selectioncode=array();
                    ...
                    if($subject=="industrial_mathematics"){
                        $selectioncode[5]="AMT221b";
                            ...
                            $get_credit="select distinct(cu.code),cu.credits as cdt from courseunit cu, target_group tg, combination co  where tg.subject='$subject' and tg.target_id=cu.target_group and co.subject='$subject'and co.department=cu.department and (cu.type='Theory' or cu.type='Th+Pr') and cu.availability=1";
                            $result_credit=mysql_query("$get_credit");
                            while($row=mysql_fetch_array($result_credit)){
                                $course=$row['code'];
                                $scredit=$row['cdt'];
                                if(!in_array($course,$selectioncode)){
                                    $alcredit=$alscredit+$scredit;
                                                                         }
                                                                             }
			...
			public function chkcorbetter($student,$subject)
			{
                ...
                ////////get all courses from result//////////////
                            ...
                            $get_course="select distinct(cr.course),cu.credits from courseunit cu, registration cr, target_group tg, combination co where cr.student='$student' and cr.course=cu.code and tg.subject='$subject' and tg.target_id=cu.target_group and co.subject='$subject' and co.department=cu.department and cu.core='co' and (cu.type='Theory' or cu.type='Th+Pr') and cr.degree='1' and cr.confirm=1 order by cu.level,cu.semister,cu.code";
            ...
            public function allopcorbetter($student)
			{
			 ...
			 ////get all op courses from result//////////////////////////
                    ...
                    $get_code="select distinct(cr.course),cu.credits from courseunit cu, registration cr where cr.student='$student' and cr.course=cu.code and cu.core='op' and cr.degree='1' and cr.confirm=1 order by cu.level,cu.semister,cu.code";
			//editet for cs


		    $get_stream="select stream from student where id='$student'";
		    $result_grade=mysql_query("$get_grade");
                                $result_stream=mysql_query("$get_stream");

                                $stream=mysql_fetch_array($result_stream);
             					$g_stream=$stream['stream'];
			//end
			...
			public function allpracticalunit($student)
			{
                ...
                $alprcrdt=0;
			         for($i=0;$i<count($subjectA);$i++){
                         $subject=$subjectA[$i];
                         /*$quegetalprctcode="select distinct(cu.code),cu.credits from courseunit cu, target_group tg, combination co where tg.subject='$subject' and tg.target_id=cu.target_group and co.subject='$subject' and co.department=cu.department and cu.core='co' and cu.type='Practical'";*/
                         $quegetalprctcode="select distinct(cu.code),cu.credits from courseunit cu, target_group tg, combination co where tg.subject='$subject' and tg.target_id=cu.target_group and co.subject='$subject' and co.department=cu.department and cu.core='co' and cu.type='Practical' and cu.availability=1";
			...
			public function chkprcminorbetter($student,$subject)
            {
                ...
                ////////get all courses from result//////////////
                            ...
                            $get_course="select distinct(cr.course),cu.credits from courseunit cu, registration cr,  target_group tg, combination co where cr.student='$student' and tg.subject='$subject' and tg.target_id=cu.target_group and co.subject='$subject' and co.department=cu.department and cr.course=cu.code and cu.core='co' and cu.type='Practical' and cr.degree='1' and cr.confirm=1 order by cu.level,cu.semister,cu.code";
