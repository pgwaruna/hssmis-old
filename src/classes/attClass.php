<?php
	...
	class attendence
	{
			...
			$query232="select count(r.student) as count from registration r, $fmviweque where r.course = '$subject' and r.acedemic_year='$acy'  and r.confirm='1' and r.student=fs.user_name ";
			...
			{
			   $fmviweque="rumisdb.fohssmisStudents fs";
			$query2322="select count(p.status) as count from participation p, $fmviweque where p.lect_id = '$lect_id' and p.student=fs.user_name";
...
/*//edited....................................pppppppp.......................................................
 ...
 p.student = '$std' and l.type = '$type' and l.acc_year='$acy' and l.course in (select code as course from courseunit where department='$getcodept' and level='$getcolv')";
			...
			{
			$query2322="select max from maxatt where acc_year = '$acc_year' and course= '$course' and type = '$type'";
			$data22322=mysql_query($query2322);
			...
			public function getNoStd($lid)
			{
                ...
                $fmviweque="rumisdb.fohssmisStudents fs";
			$query2325="select count(p.status) as co from participation p, $fmviweque where p.lect_id = '$lid' and p.student=fs.user_name";
			...
			$query230="delete from maxatt where course='$sub' and acc_year='$acc' and type='$type'";
