...
echo"<tr bgcolor='#d7aadb'><td align='center' colspan=2>";
...
$pfile=$prmimenu.".gif";
echo "<img src=images/small/$pfile width=65px height=65px><br><font size=4>".ucfirst($prmimenu)."</font>";

		$query2="select id,description from permission where role_id=$role and permi_group='$prmimenu'";
		$prev=mysql_query($query2);
		echo"<table class='menu' id='tuto$prmimenu' align='left' border='0'  bgcolor='#f2cff8'>";
...
if((($_SESSION['login'])=="$true")&&(($_SESSION['userhost'])!="rumis")){
echo"<div align='center'>";
////////////////////////// include page/////////////////////////////////////////////////////////////////////////////////
	if(isset($admin)){
			echo '<h class="bar">';
...
$picname="../rumis/picture/user_pictures/student_std_pics/".$_SESSION['ru_st_user_id'].".jpg";
...
echo"<hr class='bar'>Welcome! ".strtoupper($_SESSION['last_name'])." ".strtoupper($_SESSION['initials']). "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ <a href=index.php?task=edit>Change My Password</a> ]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ <a href='logoff.php'>Log Out</a> ]<hr class='bar'>";
$role=$_SESSION['role_id'];
...
/////////////////////////////////////////////////////////////////////////////////////////
elseif((($_SESSION['login'])=="$true")&&(($_SESSION['userhost'])=="rumis")){
...
//echo"<tr><td align='center' colspan=2 ><h3>University of Ruhuna<br>Matara-Sri Lanka</h3>For Support<br>Contact: +94 71 3216630<br>E-Mail:  janak@maths.ruh.ac.lk</td><td>";
echo"<tr><td align='center' colspan=2 ><br><br><h3>University of Ruhuna<br>Matara-Sri Lanka</h3>For Support<br>Contact: +94 71 3216630<br>E-Mail:  janak@maths.ruh.ac.lk <br><br><br><br><font size=3px color=blue>Each <b>Student User</b> Must add <b>'sc'</b> prefix to their current <b>User Name</b> to Login to the System<br><font color=red><b> Eg:- sc5291 , scps137</b></font></td><td>";
...
echo"<tr><td align='center' colspan=3><br>&#169 Faculty of Science, University of Ruhuna. [ <a href='index.php?task=showprof'>About FOSMIS</a> ] </td></tr>"; 
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////end footer //////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var number2 = new Spry.Widget.ValidationTextField("number2", "integer", {validateOn:["change"]});
