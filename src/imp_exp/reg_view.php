...
if (isset($_SESSION['login']) == "turefohssmis") {
    ...
    if ($stream_reg == "All") {
        $query1_2 = "select distinct r.course from registration r, courseunit c where r.acedemic_year='$acedemic_reg' and (r.semister='$semister_reg' or r.semister=3) and c.code=r.course and c.level='$level_reg' and c.by_low_version='$curriculum' order by r.course";
    } else {
        $query1_2 = "select distinct r.course from registration r, courseunit c where r.acedemic_year='$acedemic_reg' and (r.semister='$semister_reg' or r.semister=3) and c.code=r.course and c.level='$level_reg' and c.stream='$stream_reg' and c.by_low_version='$curriculum' order by r.course";
    }
...
//	$query1_3="select distinct student from registration where acedemic_year='$acedemic_reg' and semister='$semister_reg'";
    ...
    while ($data2 = mysql_fetch_array($reg_two)) {
        ...
        if ($stream_reg == "All") {
            $query1_4 = "select distinct r.course from registration r, courseunit c where r.acedemic_year='$acedemic_reg' and (r.semister='$semister_reg' or r.semister=3) and c.code=r.course and c.level='$level_reg' and c.by_low_version='$curriculum' order by r.course";
        } else {
            $query1_4 = "select distinct r.course from registration r, courseunit c where r.acedemic_year='$acedemic_reg' and (r.semister='$semister_reg' or r.semister=3) and c.code=r.course and c.level='$level_reg' and c.stream='$stream_reg' and c.by_low_version='$curriculum' order by r.course";
        ...
        while ($data3 = mysql_fetch_array($reg_three)) {
            ...
            ////////////////////////////////////////////////////////////////////
            $quegetmdm2 = "select medium from courseunit where code='$course_select' and by_low_version='$curriculum'";
            ...
            for ($mdm = 0; $mdm < $flpelmnt; $mdm++) {
                ...
                $query1_5 = "select r.confirm, r.degree from registration r, student s where r.acedemic_year='$acedemic_reg' and (r.semister='$semister_reg' or r.semister=3) and r.course='$course_select' and r.student='$student_select' and r.student=s.id and s.medium='$getmdm22' and s.curriculum='$curriculum'";
                //echo$query1_5;
