...
<hr class=bar>
Select the date for add medical
<div id="create_l">
<br>
<div align="center">
...
<select size="2" name="dept_subject" id="dept_subject" onclick="displayCourses()">
<?php
$deptment=$_SESSION['section'];
echo '<option value="'.$deptment.'">'.ucfirst($deptment).'</option>';
...
<img style='visibility: hidden' id='loader6' src='images/ajax-loader.gif'>
	...
	<select size="8" name="dept_courses" id="dept_courses" onclick="displayLid()">
	...
	<div id="lid" name="lid">
	<select size="5" name="lect_id" id="dept_courses1" >
