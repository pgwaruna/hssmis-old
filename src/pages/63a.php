...
///display 3rd condition///////////////////////////////
    ...
    if($g_stream=="bcs")
    	echo"<tr class=trbgc><td align='center'>3</td><td>* Grades of C or better aggregating to a minimum of 60% credits of optional course unit </br></br>[ Registered total credits for optional course unit : <font color=red>".$alopcdt."</font>&nbsp;] [&nbsp;C or better credits for optional course unit : <font color=red>".$dorbeterptg."</font>&nbsp;] [&nbsp;Precentage : <font color=red>".$dorbtptge."%</font> ]</td>";
    else
		echo"<tr class=trbgc><td align='center'>3</td><td>* Grades of D+ or better aggregating to a minimum of 60% credits of optional course unit </br></br>[ Registered total credits for optional course unit : <font color=red>".$alopcdt."</font>&nbsp;] [&nbsp;D+ or better credits for optional course unit : <font color=red>".$dorbeterptg."</font>&nbsp;] [&nbsp;Precentage : <font color=red>".$dorbtptge."%</font> ]</td>";
...
///display 5th condition///////////////////////////////
	...
	echo"<tr class=trbgc><td align='center'>5</td><td>* A Grade Point Average (GPA) of 2 or more </br></br>[ Current GPA : <font color=red>".round($crtgpa,2)."</font> ]</td>";
	if(round($crtgpa,2)>=2){
		echo"<td align='center'><img src=./images/conf31.png><br>Complete</td></tr>";
		$req[4]="ok";
			}
...
///display 6th condition///////////////////////////////
	...
	echo"<tr class=trbgc><td align='center'>6</td><td>* Pass the English Proficiency Level 1 & Level 11</form> </br></br> ";
...
//////condition fsc clculation part/////////////////////////////////////
		...
		echo"<tr class=trbgc><td align='center'>7</td><td>* A maximum of 6 credits register for FSC and Cannot exceed this credit limit</br></br><font color=red>[ Registered ".$alfsccdt." credits ]</font></td>";
			if($alfsccdt<=6){
				echo"<td align='center'><img src=./images/conf31.png><br>Complete</td></tr>";
				$req[6]="ok";
			}
...
///display 7th condition///////////////////////////////
	...
	if(!in_array("computer_science",$subjectA)){
		...
		echo"<tr class=trbgc><td align='center'>8</td><td><font class=minreq>* Pass the examination of Computer Literacy Course (ICT1b13)</form> </br></br>";
...
///display 8th condition///////////////////////////////
		...
		echo"<tr class=trbgc><td align='center'>9</td><td>* Pass in course unit MAT1142 (Mathematics of Biology) </br></br>";
