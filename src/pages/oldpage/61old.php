...
//echo$firstcho.$secndchoi.$padd1.$padd2.$padd3.$padd4.$dob.$nic.$land.$mobil.$email.$olindex.$olyear.$maths.$scie.$buddis.$sinha.$engl.$sosnh.$art_sub.$art_g.$other_sub1.$othr1.$other_sub2.$othr2.$other_sub3.$othr3.$other_sub4.$othr4.$other_sub5.$othr5.$alindex.$alyear.$phy.$che.$commat.$bio.$adsub.$adsubgd.$geneng.$zscor.$gentmrks;
   ...
   ////////////////////special data ///////////////////////////////////////////////////
        ...
        if(mysql_num_rows($quchkspreg)==0){
            ////////////////sp insert//////////////////
            $quespdatainst="insert into special_registration(stno,ac_year,choice_one,choice_two,choice_three,hand_over_date,conf_subject) values('$spstno','$crr_acyear','$firstcho','$secndchoi','$terddchoi','$today','In Progress')";
           mysql_query($quespdatainst);
        }
        else{
            ///////////////sp update//////////////////
            $queupspreg="update special_registration set choice_one='$firstcho', choice_two'$secndchoi',choice_three='$terddchoi', hand_over_date='$today', conf_subject='In Progress' where stno='$spstno'";
...
//echo $specialsub[0]."+".$specialsub[1];
    ...
    if($status==1){
        ...
        if(mysql_num_rows($qucheckspreg)!=0){
            echo"<br>Your Registration Datails of Bachelor of Science(Special) Degree <br>";
            ...
            echo"<form method=post action='./index.php?view=admin&admin=61&task=sbspapfm' id='specialapply'>";
        ...
        echo"<span class='textfieldInvalidFormatMsg'><font size='-1'>Invalid format</font></span>";
         ...
         echo"<tr><td align=right>7.2. G. C. E. (A/L) <td> : Index No<input type=text name=alindex value='$alindexno' size=12>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                ...
                echo"<tr><td>8. Submited Date<td> : $today";
        ...
        echo"<font color=red>Sorry! Appling for Bachelor of Science (Special) Degree is Closed.</font><br>";
        ...
        if(mysql_num_rows($qucheckspreg)!=0){
            ...
            echo"<br>You are not registered for Bachelor of Science (Special) Degree<br><br>";
