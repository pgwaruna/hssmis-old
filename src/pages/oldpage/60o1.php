...
if($task=="strspreg"){
    ...
    $status=$_POST['status'];
      ...
      $que_ins_spreg="insert into call_special_application(acc_year,end_data,status) values('$crr_acyear','$enddate',$status)";
...
if(mysql_num_rows($qugetspst)!=0){
   echo"<div id=m>"; 
      ...
      if(mysql_num_rows($qugetsublst)!=0){
        ...
        echo"<th>Other Choices<th>View Application<th>Confirm Subject<th>Submit";    
      ...
      ///////////////////////////////////// sub end///////////////////////////////////////////////////////////////////// 
                  ...
                  while($qgetspst=mysql_fetch_array($qugetspst)){
                      echo"<form method=POST action='./forms/form_60.php'>";
                           ...
                           //////////////////////////////////////////
                           echo"<td align=center>SC/$spstbt/$spstno<td>$spstnm";
                           /////////////////////////////////////////////////////////////////////////////
                           ...
                           if($conf_subject=="In Progress"){
                               ...
                               echo"<td align=center>&nbsp;<td align=center><input type=submit value='Confirm' name='cnfbttn'>";
                               
                           }
                           elseif($conf_subject==$choice_one){
                               echo"<td align=center><font color=blue><b>".strtoupper($conf_subject)."</b></font><td align=center><input type=submit  name='cnfbttn' value='Cancel'>"; 
