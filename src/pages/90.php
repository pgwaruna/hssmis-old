<?php
session_start();
if((($_SESSION['login'])=="truefohssmis")&&($_SESSION['role']!="6")){
error_reporting(0);
?>
<style type="text/css">
...
echo"<td colspan='1'  valign='middle'><font size='6' >Faculty of Humanities and Social Sciences";
echo"<br><font size='5'>Management Information System";
echo"<br>[ F O H S S M I S ]";
echo"</font></td></tr>";
...
echo"<td colspan='3'><div><marquee scrollamount='3' onmouseover='this.stop();' onmouseout='this.start();' style='width:765px;'>Welcome To The Management Information System!&nbsp;&nbsp;&nbsp;";
include "../news.php";
echo"</marquee></div></td>";
...
echo"<h3>Informations of Your Mentoring Student </h3></td>";
...
///////////////////////////////////////////////////////////
	...
	echo"<th>Student Number</th><th>Name with Initials</th><th>Stream</th><th>Current Level</th><th colspan='3' align='center' width=30%>View Informations</th></tr>";
echo"<form method='POST' action='?task=viewinf&due=prew'>";
	...
	$getspsub=$divspsub[1];
      ...
      echo strtoupper($getsub);
      echo" <br>Special Degree";
	...
	if($gtlvl!=0){
	echo"</td><td align='right'><input type='submit' value='Personal' name='bttnm'>";


		if(mysql_num_rows($quswbev)!=0){
		echo"<input type='submit' value='Special Behaviour' name='bttnm'>";
			}

	    echo"<input type='submit' value='Hostel' name='bttnm'></td>";
	echo"<td align='center'><input type='submit' value='Results' name='bttnm'></td>";
	echo"<td align='left'><input type='submit' value='Current Attendence' name='bttnm'>";
	...
	echo"<td align='left'><input type='submit' value='All Attendence' name='bttnm'>";
		echo"<input type='submit' value='Course Registration' name='bttnm'></td>";
...
echo"<br><div align='center'><h4>$submit Informations of &nbsp;$lname &nbsp;$initi ($st) </h4></div>";
...
////////////////////////////////////////////////////////////////////
	...
	if($submit=="Course Registration"){
			...
			///////////////////// display course detaials//////////////////
				...
				echo"<table border=0 align='center'><th>Course Unit<th>Course Name<th>Reg. Acedamic Year<th>Reg. Semester<th>Degree Status<th>Final Max Result [ Year ]";
...
if($task=='check'){
	...
	echo"<table border='0' align='center'><tr>";
	echo"<th>Photo<th>Student Number</th><th>Name with Initials</th><th>Stream</th><th>Current Level</th><th colspan='3' align='center' width=30%>View Informations</th></tr>";
...
///////////////////////////////////////////////
	...
	echo"<td align='center'>HS/$batch/$id<input type='hidden' name='stno' value='HS/$batch/$id'></td><td align='center'>$l_name $initials<input type='hidden' name='flname' value='$l_name-$initials'></td><td align='center'>";
...
//////////////////////////////////////////end main////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
echo"</td></tr><tr><td colspan='3' align='center'> © Faculty of Humanities and Social Sciences, University of Ruhuna. <a href='../profile.php'>About FOHSSMIS</a>&nbsp;</td></tr>";
echo"</table>";
echo"</div>";
?>
