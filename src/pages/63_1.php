...
///display 1st condition///////////////////////////////
	...
	echo"<tr class=trbgc><td align='center'>1</td><td>* A minimum of 90 credits registrer for degree</br></br><font color=red>[ Registered $crttotcrdt credits ]</font></td>";
	if($crttotcrdt>=90){
...
///display 7th condition///////////////////////////////
	...
	if(!in_array("computer_science",$subjectA)){
		...
		echo"<tr class=trbgc><td align='center'>7</td><td><font class=minreq>* Pass the examination of Computer Literacy Course (ICT1b13)</form> </br></br>";
...
///display 8th condition///////////////////////////////
		...
		echo"<tr class=trbgc><td align='center'>8</td><td>* Pass in course unit MAT1142 (Mathematics of Biology) </br></br>";
