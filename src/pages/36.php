...
$query_21_1="select code, name from courseunit where (coordinator='$lec_id' or lecturers LIKE '%[$lec_id]%')   and availability=1 and (semister=$find_L or semister=3)  order by code,name";	
}
...
echo "You have following subjects for view attendance ";
...
echo '<tr align="left" class="trbgc" height=25px><td align=center>'.$cutbl.'<td align=center><a href="index.php?view=admin&admin=36&attdisp=displayatt&sub='.$attdata['code'].'&task8=attendence&display=all"';
?>

onclick="viewWindow(this.href,'mywin','1200','600','yes','center');return false";
...
echo "</table>";
	...
	echo"<br>Sorry! Can not find course unit to view registration for you<br>";
}
mysql_close($con21_1);
...
echo "<br /><font color=red>Current Attendences of ".$sub_21." Course Unit &nbsp;&nbsp;| &nbsp;&nbsp;&nbsp; ".ucfirst($selection)." Type</font>";
////////////////////////////
////////////////////////////
////////////////////////////
...
$header="Current Attendence Sheet Data of ".$sub_21."  |  ".ucfirst($selection)." Type\n\n\n";
fwrite($fh, $header);
////////////////////////////
////////////////////////////
////////////////////////////
...
////////////////////////////
	...
	echo '<br /><br /><div align="center"><table border="0" width="100%" cellspacing="1" cellpadding="2" bordercolor="#C0C0C0" bgcolor="#000000"><tr align=center ><td bgcolor="#A8FFA8" align=center valign=middle>#<td bgcolor="#A8FFA8">&nbsp;';
...
////////////////////////////	
	...
	$query_21_8="select distinct r.student, s.batch from registration r,  student s, $fmviweque where s.id=r.student and r.course = '$sub_21' and r.acedemic_year='$acy' and r.confirm='1' and r.student=fs.user_name order by r.student";
  	//echo$query_21_8;
...
////////////////////////////
	...
	$stprmtnum=$vr36->getStudentNumber($getstlstdgt); 
	if($stprmtnum==null){
