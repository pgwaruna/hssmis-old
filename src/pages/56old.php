...
echo"<font color='red'>Sorry !, SC/$byear/$stno is Invalid Student Number.</font><br>";
		      }
else{

echo"<b>All Registration Status of $stname ( SC/$stregbt/$stno )<br>";
...
echo"</tr>";
echo"<tr class=trbgc><td align=center><b>SC/$stregbt/$stno</b></td>";
...
echo"<b>Registration Status of Level $levl [ $drop ] Students</b><br>";
	...
	$quegtlvlst="select s.id, s.batch, s.l_name, s.initials, s.stream from student s, level l where l.level='$levl' and l.year=s.year order by s.id";
	//echo$quegtlvlst;
...
////////////////////////////////////////////////////////////////////////////////////////////
    ...
    if($dropst=="yes"){
    echo"<tr class=selectbg4><td colspan=7 align=center>Sorry!There are no any drop student found";
            }   
