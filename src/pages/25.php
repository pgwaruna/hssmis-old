...
window.location= 'index.php?view=admin&admin=25&attdisp=displayatt&sub='+subj+'&task8=attendence&display='+ selected_Value;
...
echo '<tr align="left" class="trbgc"><td><a href="index.php?view=admin&admin=25&attdisp=displayatt&sub='.$attdata['code'].'&task8=attendence&display=all"';
?>
...
<?php
echo '>'.strtoupper($attdata['code'])."</a><td>".ucfirst($attdata['name']);
...
echo"<br>Your department haven't initiate any subject for you .<br><br>";
echo '<hr class=bar>';
	}		
mysql_close($con21_1);
}						
...
<?php    
echo '<a href="export_data/att/'.$id_save.'.csv" target="_blank"><img border="0" src="images/small/old-ooo-template.png"></a> ';
...
////////////////////////////	
	...
	$query_21_8="select distinct r.student, s.batch from registration r, student s, $fmviweque where s.id=r.student and r.course = '$sub_21' and r.acedemic_year='$acy' and r.confirm='1' and concat('sc',r.student)=fs.user_name order by  r.student";
