...
if($task=="oneadd"){
$quecknum="select batch from student where id='$onestno'";
...
SC/$batch/$admisid&nbsp;</td></tr></table></td></tr></table>";
			...
			echo"<tr><td colspan=3><table border='0'><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; පරීක්ෂණය<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Examination</td><td><image border='0' src='../images/bract.gif' ></td><td>Bachelor of Science Genaral Degree Level I,II & III (Semester $cseme) Examination</td></tr></table></td>";
			...
			echo"<tr height='25px'><td align='center' colspan=7>ND : Not Decide &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EL : Eligible &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NE : Not Eligible </td></tr>";
			echo"</table>";
...
$quegtstfomlvl="select distinct(r.student) from registration r,student s,level l where l.level=$gtgplvlnum and l.year=s.batch and s.id=r.student";
...
echo"<tr><td align='center' colspan=7>ND : Not Decide &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EL : Eligible &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NE : Not Eligible </td></tr></table>";
