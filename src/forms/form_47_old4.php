...
$tnpcourse[37]="CHE322A";
$tnpcourse[38]="PHY3272";
$tnpcourse[39]="PHY4144";
$tnpcourse[40]="ZOO3292";
$tnpcourse[41]="ZOO2262";
...
$queckexreg="select course from exam_registration where acedemic_year='$acy' and semester=$cseme and student='$admisid'";
		...
		if(mysql_num_rows($quckexreg)!=0){
			...
			while($qckexreg=mysql_fetch_array($quckexreg)){
				...
				if($ststrmlng!=3){
					$quechksprptnot="select grade from results where index_number='$admisid' and subject='$excocode'";
					//echo$quechksprptnot;
					$quchksprptnot=mysql_query($quechksprptnot);
						if(mysql_num_rows($quchksprptnot)==0){
								$stleve=$cslvl;
											}
							}
//echo$cslvl.$stleve;
...
//////////////////////////////////////////////////////////////////////////////////////////
		...
		///////////////////START ADMISSION///////////////////////////////
			...
			echo"<tr><td colspan=4 align=right>&nbsp;$pntdt47</td></tr>";
...
$quecknum="select length(stream) as stlng from student where id='$admisid'";
//echo$quecknum;
$qucknum=mysql_query($quecknum);
$qcknum=mysql_fetch_array($qucknum);
	$ststrmlng=$qcknum['stlng'];
