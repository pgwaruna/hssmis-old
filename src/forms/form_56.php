...
<table border="0" width="87%" cellspacing="1">
	<tr>
		<td align="center">
<form method="POST" action='./index.php?view=admin&admin=56&task=onest'>
	<font size="2" color="#FF0000">&nbsp;&nbsp; </font>
	<font color="#800000">&nbsp;Index Number :</font>&nbsp;
	<font color="#800000">HS/</font>

<?php
echo'<select size="1" name="year56">';
...
<font color="#800000">/</font>
	<span id="number1">
	<input type="text" name="index56" size="4">&nbsp;
	...
	(<span style="font-size: 10pt"> Ex: HS/2016/15291) </center></span></font></form></td>
	</tr>
</table>
