...
<table border="0" width="87%" cellspacing="1">
	<tr>
		<td align="center">
<form method="POST" action='./index.php?view=admin&admin=59&task=onest'>
	<font size="2" color="#FF0000">&nbsp;&nbsp; </font>
	<font color="#800000">&nbsp;Index Number :</font>&nbsp;
	<font color="#800000">SC/</font>

<?php
echo'<select size="1" name="year59">';
...
<font color="#800000">/</font>
	<span id="number1">
	<input type="text" name="index59" size="4">&nbsp;
	...
	<input type="submit" value="Submit" name="submit59"> <br>
