...
if($sttream=="all"){
$quegetblkst="select id,batch from student where year='$strgyr' order by id";
}
else{
$quegetblkst="select id,batch from student where year='$strgyr' and stream='$sttream' order by id ";
}
