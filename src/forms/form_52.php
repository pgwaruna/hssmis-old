...
$thurty=array(61,128,196,264,372);
...
/////////////////////...............................................////////////////////////////////////////////
	echo"<table border=0 align='center' width=80%><tr><td align='center' colspan=2><font size='3px'><b>Attendance Sheet - Level $prtcolvl"."000 and Semester $prtcosem of $prtcrtacy Academic Year</b></font></td></tr>";
...
/////////////////////...............................................////////////////////////////////////////////
		...
		echo"<table border=1 cellspacing='0' cellpadding='0' ><tr height=22px><td width=5% align='center'>NO<td width=30%   align='center'>NAME <br>WITH INITIALS<td width=22% align='center'>STUDENT NUMBER<td width=28% align='center'>SIGNATURE</tr>";
  ...
  $fmviweque="$rmsdb.fohssmisStudents fs";
		...
		while($qprtatn=mysql_fetch_array($quprtatn)){
			...
			$initials=$qprtatn['initials'];
				...
				echo"<tr height=28px><td align='center'>$i<td>&nbsp;&nbsp;$l_name<br>&nbsp;$initials<td align='center'>$fulstno<td>&nbsp;</tr>";
