...
SC/$batch/$admisid&nbsp;</td></tr></table></td></tr></table>";
			...
			/*//////////////////////////check cos reg//////////////////////////////////
			$quechkcsregfoadm="select course from registration where acedemic_year='$acy' and semister=$cseme and student='$admisid' and confirm=1 order by course";
			$quchkcsregfoadm=mysql_query($quechkcsregfoadm);
			if(mysql_num_rows($quchkcsregfoadm)!=0){
				while($qchkcsregfoadm=mysql_fecth_array($quchkcsregfoadm)){
						$chkcsregfoadm=$qchkcsregfoadm['course'];
												}
								}
			/////////////////////////////////////////////////////////////////////////*/
			...
			echo"<tr height='25px'><td align='center' colspan=7>EL : Eligible &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NE : Not Eligible &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NC : Not Confirm</td></tr>";
			echo"</table>";
...
echo"<tr><td align='center' colspan=7>EL : Eligible &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NE : Not Eligible &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NC : Not Confirm</td></tr></table>";
