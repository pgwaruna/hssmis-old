...
if($task=="oneadd"){
//echo"One";
$quecknum="select batch, stream  from student where id='hs$onestno'";
...
$queckexreg="select course_code from exam_registration where academic_year='$acy' and semester=$cseme and std_id='hs$admisid'";
//echo$queckexreg;
