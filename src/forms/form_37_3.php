...
<table border="0">
	<tr class="trbgc">
		<td align="center">
<form method="POST" action='./index.php?view=admin&admin=37&task=eregister&blk=sprg'>
...
<font color="#FF0000"><center>
	(<span style="font-size: 10pt"> Ex: HS/2016/15291) </center></span></font></td>
<tr class="trbgc"><td align="center">	
<select name="regflt">
		<option value="current" >Special Degree Registration</option>
		<option value="old">General Degree Registration</option>
</select>
